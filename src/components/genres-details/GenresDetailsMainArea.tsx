                ...
                <div className="row">
                    ...
                    <div className="col-xl-8 col-lg-7">
                        <div className="ms-event-details-content mb-40">
                            ...
                            {/* Event Title */}
                            <h2 className="mb-20" style={{ color: 'white' }}>We Are A Group Of Artists, Musicians, Producers, DJs...</h2>
                            ...
                            <div className="event-btns"  style={{ display: 'flex', gap: '8px' }}>
                                ...
                                <Link href="/checkout" className="vr-btn"><span>Book Now</span></Link>
                                <Link href="/cart" className="ms-addto-cart-btn" style={{ color: 'white',border: '1px solid white' }}><span>Available Seats</span></Link>
