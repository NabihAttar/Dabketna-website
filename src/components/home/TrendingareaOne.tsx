            ...
            <div className="container">
                <div className="row align-items-end mb-25 bdFadeUp">
                    <div className="col-lg-8">
                        <div className="section__title-wrapper mb-40 bd-title-anim">
                            <span className="section__subtitle">Weddings</span>
                            <div id="msg-title">
                                <h2 className="section__title"><span className="animated-underline active">Where the World
                                    </span> {" "}
                                    Dances Dabke</h2>
                            </div>
                        </div>
                ...
                <div className="row bdFadeUp">
                    <div className="trending-grid">
                        ...
                        >
                            {
                                trending_genre_data.slice(0, 3).map((item) => (
