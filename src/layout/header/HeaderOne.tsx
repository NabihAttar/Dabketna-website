...
import headerLogo from "../../../public/assets/img/logo/newLogo.svg";
                                ...
                                <div className="mega__menu-wrapper p-relative">
                                    <div className={pathName === '/' ? "header__main d-flex ms-border2 align-items-center justify-content-between" :
                                        ...
                                        <div className="header__logo pt-25 pb-25">
                                            <Link href="#">
                                                <Image loader={imageLoader} priority width={143} height={68} src={headerLogo} alt="logo not found" />
                                            </Link>
                                        </div>
                                        ...
                                        <div className="header__right">
                                            ...
                                            <button className="nav-link " id="nav-faq-1-tab" data-bs-toggle="tab" style={{ backgroundColor: "#A51818", color: "#fff" }}
                                                data-bs-target="#nav-faq-1" type="button" role="tab"
                                                aria-controls="nav-faq-1" aria-selected="true">Contact Us</button>
                                                </div>
                                                    <div className="ms-browse-act-item-wrap p-absolute">
                                                        <div className="ms-song-item">
                                                            <div className="ms-song-img p-relative">
